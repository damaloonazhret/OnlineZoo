...
//     return `
//     <div class="video-animals--1 video-animals--hov video-animals--nobg ${animal.class}">
//         <a href="${animal.href}">
//             ${animal.src}
//         </a>
//         <p></p>
...
//     },
// ];
// videoPlaceholder.style.transition = '0.3s ease-in-out';
// function openSliderVideoPanel() {
//     videoPlaceholder.style.opacity = '0';
//     videoPlaceholder.style.transform = 'translateX(' + (-25) + '%';
//     setTimeout(() => {
...
//             videoPlaceholder.style.transform = 'translateX(' + (0) + '%';
...
// function closeSliderVideoPanel() {
//     videoPlaceholder.style.opacity = '0';
//     videoPlaceholder.style.transform = 'translateX(' + (-25) + '%';
//     setTimeout(() => {
